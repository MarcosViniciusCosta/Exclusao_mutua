...
public class P1 implements Operacoes_secao_critica{
	...
	public static void main(String[] args) 
	{
		...
		try {    	
			...
			Operacoes_secao_critica stub_enquanto_servidor = (Operacoes_secao_critica) UnicastRemoteObject.exportObject(new P1(), 0);
